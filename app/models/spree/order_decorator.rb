Spree::Order.class_eval do
  ...
  alias_method :awaiting_return_without_legacy_return_authorizations?, :awaiting_return?
  alias_method :awaiting_return?, :awaiting_return_with_legacy_return_authorizations?
end
